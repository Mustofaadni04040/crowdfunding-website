        ...
        <div className="grid w-full justify-between sm:flex sm:justify-between md:flex lg:p-10 lg:gap-10">
          <div className="max-w-96 mb-7">
            ...
            <p className="mt-3 text-sm text-slate-500">
              Bersama Palestina adalah lembaga donasi nasional, yang berkhidmat
              dalam pemberdayaan masyarakat palestina melalui pendayagunaan
              donasi baik dari perseorangan, lembaga, perusahaan dan instansi
              lainnya. Bersama Palestina tidak menerima segala bentuk dana yang
              bersumber dari kejahatan. UU RI No. 8 Tahun 2010 Tentang
          ...
          <div className="grid grid-cols-2 gap-8 sm:mt-4 sm:grid-cols-2 sm:gap-6">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                ...
                <Footer.Link href="/fundraisers" className="hover:text-primary">
                  Donasi
                </Footer.Link>
